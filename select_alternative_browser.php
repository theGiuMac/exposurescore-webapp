...
AND ((new_privacy_score + cvss_score) < $final_score) and `version` not like '0.0' and cvss_score < 5 ORDER BY cvss_score DESC, new_privacy_score DESC, version DESC limit 5";
